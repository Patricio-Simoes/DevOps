...
1. Common Terraform files  across projects include:
	...
	4. **`providers.tf`** - [Providers](02.%20Providers.md#02.%20Providers) requirements;
...
1. Always encrypt the [state file](01.%20State%20file.md#01.%20State%20file);
...
4. Always use a `.gitignore` in order to avoid committing sensitive data to a remote git repository.
