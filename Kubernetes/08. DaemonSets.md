...
A DaemonSet is very similar to a [ReplicaSet](03.%20ReplicaSets.md#03-replicasets), the difference however, is that a DaemonSet **ensures a particular [pod](02.%20Pods.md#02-pods) runs on every [node](01.%20Overview.md#nodes-minions)** of the cluster. 
...
To describe a DaemonaSet, using `kubectl` run:
