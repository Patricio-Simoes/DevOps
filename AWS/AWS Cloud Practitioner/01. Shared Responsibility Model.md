...
- For [EC2](04.%20Amazon%20EC2.md#04.%20EC2) instances, the customer is responsible for management of the guest OS, firewall, network configuration and [IAM](03.%20IAM.md#03.%20IAM);
...
**Note:** For more detailed information, see [AWS - Shared Responsibility Model](https://aws.amazon.com/pt/compliance/shared-responsibility-model/).