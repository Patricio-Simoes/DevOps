...
- **Implement a strong identity foundation** - Centralize privilege management and reduce (or even eliminate) reliance on long-term credentials. (Principle of least privilege). [IAM](03.%20IAM.md#03--iam).
