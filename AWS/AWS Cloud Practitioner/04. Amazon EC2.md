...
It is a fundamental [IaaS](00.%20Cloud%20Concepts.md#infrastructure-as-a-service-iaas) service that allows customers to run applications on virtual servers without investing into physical hardware.
...
- How storage space the machine will have:
	- Network attached ([EBS](#ebs-volumes) & [EFS](#efs-volumes));
	- Hardware ([EC2 Instance Store](#ec2-instance-store)).
- The network card:
...
- Reserve On Demand model instances capacity in a specific [availability zone](02.%20AWS%20Global%20Infrastructure.md#availability-zones-azs) for any duration;
...
**Note:** EBS volumes can be mounted to a **single instance at a time** and are bound to specific [availability zones](02.%20AWS%20Global%20Infrastructure.md#availability-zones-azs).
...
EBS Snapshots are backups of EBS Volumes at a point in time. They can be copied across [regions](02.%20AWS%20Global%20Infrastructure.md#availability-zones-azs)).

<div align="center">
  <img src="../../Assets/Images/AWS - EBS Snapshots.png" alt="AWS - EBS Snapshots" />
</div>
...
While [EBS Volumes](#ebs-volumes) have good performance, the fact that they are network drives limits their potential.
...
EFS volumes are highly available, scalable and are about 3x more expensive that [EBS Volumes](#ebs-volumes).

<div align="center">
  <img src="../../Assets/Images/AWS - EFS Volumes.png" alt="AWS - EFS Volumes" />
</div>
...
<div align="center">
  <img src="../../Assets/Images/AWS - FSx for Windows.png" alt="AWS - FSx for Windows File System" />
</div>
...
<div align="center">
  <img src="../../Assets/Images/AWS - FSx for Lustre.png" alt="AWS - FSx for Lustre" />
</div>
...
<div align="center">
  <img src="../../Assets/Images/AWS - AMIs.png" alt="AWS - AMIs" />
</div>
...
<div align="center">
  <img src="../../Assets/Images/AWS - EC2 Image Builder.png" alt="AWS - EC2 Image Builder" />
</div>
