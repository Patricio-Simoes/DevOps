...
It supports standard `kubectl`commands and AWS managed the k8s control plane, while the user managed the worker nodes (via [EC2](04.%20Amazon%20EC2.md#04.%20EC2) or [Fargate](#aws-fargate-serverless)).
