...
**Note:** [EC2](04.%20Amazon%20EC2.md#04.%20EC2) instances get a new public IPv4 address on stop/start.
...
Fixed public IPv4 attached to an [EC2](04.%20Amazon%20EC2.md#04.%20EC2).
...
A subnet is a range if IPs inside a VPC, associated with a specific [AZ](02.%20AWS%20Global%20Infrastructure.md#Availability%20Zones%20(AZs)).
...
A Security Group is a **stateful firewall** attached to an [EC2](04.%20Amazon%20EC2.md#04.%20EC2) or ENIs, (Elastic Network Interfaces).
