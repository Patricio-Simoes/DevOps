...
- [SQL Databases](#sql-databases) (Serverless & Non-Serverless);
- [No SQL Databases](#no-sql-databases) (Serverless & Non-Serverless);
...
<div align="center">
  <img src="../../Assets/Images/AWS - RDS Read Replicas.png" alt="AWS - RDS Read Replicas" />
</div>
...
- Costs more that [RDS](#amazon-rds) (~20%);
...
<div align="center">
  <img src="../../Assets/Images/AWS - DynamoDB.png" alt="AWS - DynamoDB" />
</div>
...
<div align="center">
  <img src="../../Assets/Images/AWS - DMS.png" alt="AWS - DMS" />
</div>
...
EMR takes care of provisioning and configuring multiple [EC2](04.%20Amazon%20EC2.md#04--ec2) instances in a cluster so that they can work together in analyzing data from a big data perspective.
